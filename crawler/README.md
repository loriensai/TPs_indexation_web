...
4.  Si le crawler n'a pas l'autorisation de crawler, il ajoute l'URL à la liste des URLs qui ont posé problème et reviens à l'étape 2. 

5.  Si le crawler a l'autorisation de crawler, il télécharge la page.            
...
Dans l'implémentation dans ce programme, l'âge est calculé en minutes.                                  
...
*   Si elle n'existe pas, elle est ajoutée dans la table avec un âge de 0 et une date de dernière visite qui est égale à la date actuelle, c'est-à-dire à la date où on fait l'insertion (et à quelques secondes près elle correspond à la date de téléchargement). 
*   Si elle exite, c'est-à-dire qu'elle a déjà été visitée par le crawler, son âge revient à 0 et la date de dernière visite est mise à jour. 
